...
contract("voting DApp", (accounts) => {
    ...
    it("can contribute", async () => {
        ...
        console.log(gasUsed2 + " tx1 gas used")
        ...
        console.log(balanceBefore2 - balanceAfter2 + " balance1")
        console.log(balanceBefore2 - balanceAfter2 - gasUsed2   + " balance tx2")
        //console.log( + " balance after voter1")
