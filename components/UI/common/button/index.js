export default function Button({
    ...
    const variants = {
        ...
        lightBlue: `text-white bg-blue-600 ${hovarable && "hover:bg-blue-800"}`,
    }
    ...
    return (
        <button
            ...
            className={`disabled:opacity-50 disabled:cursor-not-allowed px-8 py-3 my-2 font-medium rounded-md text-base mr-8${className} ${variants[variant]}`}>
